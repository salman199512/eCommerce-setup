...
@section('title')
    View Website - TeleBark
@endsection

@section('page_headers')
    <h3><i class="fa-duotone fa-users mr-2"></i>Websites</h3>
@endsection
...
@section('page_buttons')
    <a class="btn btn-primary" href="{{ route('admin.websites.create') }}"><i class="fa-solid fa-plus"></i> Add Websites</a>
@endsection
                        ...
                        <div class="card-header">
                            <div class="w-100 d-flex justify-content-between ">
                                ...
                                <div class="d-flex align-items-center action_button">
                                    @include('admin.websites.datatables_actions', ['uuid' => $website->uuid])
                                </div>
                            </div>
                        </div>
...
@push('stackedScripts')
    <script>
        disableInputsForView($('#showwebsite'));
    </script>
@endpush
