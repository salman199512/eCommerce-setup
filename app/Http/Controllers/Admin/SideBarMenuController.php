...
class SideBarMenuController extends Controller
{
    ...
    public function recursiveRenderingFunction($sidebarItem){
        ...
        if(sizeof($sidebarItem['children']) > 0){
            $renderedHtml .= "<li class=\"slide slide has-sub\">
                                    <a class=\"side-menu__item \" href=\"#\">" . $sidebarItem['icon'] .
                "<span class=\"side-menu__label\">" . $sidebarItem['name'] . "</span> <i class=\"fe fe-chevron-right side-menu__angle\"></i></a>
