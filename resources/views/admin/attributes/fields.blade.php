...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('attribute_group_id', $attributeGroups, null, ['class' => 'form-control select2', 'placeholder' => 'Select Attribute Group']) !!}
</div>
...
<div class="form-group col-md-12 fields_footer_action_buttons">
    ...
    <a href="{{ route('admin.attributes.index') }}" class="btn  btn-outline-danger"><i class="fa-duotone fa-arrow-left-to-line"></i> Back</a>
</div>
