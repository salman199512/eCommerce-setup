...
<a href="{{ route('admin.roles.permissions.manage.index', $role->name) }}" title="Manage Permissions" class="text-secondary">
...
<a class="text-danger" href="javascript:void(0);" style="color: white; padding-bottom: 10px" onclick="ajaxCallDelete('{{ route("admin.roles.destroy", $role->name) }}',
