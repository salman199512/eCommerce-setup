            ...
            <div style="display:flex;flex-wrap:wrap;align-items:center;gap:64px;">
                <div style="flex:1;min-width:300px;">
                    ...
                    <div style="color:var(--gray-500);font-weight:600;line-height:1.7;font-size:1.05rem;">
                        ...
                        <p>
                            Every piece in our collection is meticulously curated from top global designers, ensuring it meets our rigorous standards for comfort, durability, and aesthetic excellence.
                        </p>
                    </div>
                </div>
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(300px, 1fr));gap:48px;">
                    <div style="text-align:center;padding:48px;background:white;border-radius:var(--radius-3xl);border:1px solid var(--gray-100);transition:var(--trans-base);box-shadow:var(--shadow-sm);">
                        <div style="width:64px;height:64px;background:var(--gray-50);border-radius:var(--radius-full);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;">
                            <i class="fa fa-shirt" style="font-size:1.5rem;color:var(--primary);"></i>
                        </div>
                        <h4 style="font-size:0.75rem;font-weight:900;text-transform:uppercase;letter-spacing:0.15em;margin-bottom:16px;">Eco-Conscious</h4>
                        <p style="color:var(--gray-500);font-size:0.9rem;line-height:1.6;font-weight:600;">
                            We are committed to reducing our environmental footprint through ethical sourcing and sustainable fabrics.
                        </p>
                    </div>
                    <div style="text-align:center;padding:48px;background:white;border-radius:var(--radius-3xl);border:1px solid var(--gray-100);transition:var(--trans-base);box-shadow:var(--shadow-sm);">
                        <div style="width:64px;height:64px;background:var(--gray-50);border-radius:var(--radius-full);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;">
                        ...
                        <h4 style="font-size:0.75rem;font-weight:900;text-transform:uppercase;letter-spacing:0.15em;margin-bottom:16px;">Elite Craft</h4>
                        <p style="color:var(--gray-500);font-size:0.9rem;line-height:1.6;font-weight:600;">
                            No compromises. Every stitch and material choice is made with the highest quality standards in mind.
                        </p>
                    </div>
                    <div style="text-align:center;padding:48px;background:white;border-radius:var(--radius-3xl);border:1px solid var(--gray-100);transition:var(--trans-base);box-shadow:var(--shadow-sm);">
                        ...
                        <h4 style="font-size:0.75rem;font-weight:900;text-transform:uppercase;letter-spacing:0.15em;margin-bottom:16px;">Inspiration</h4>
                        <p style="color:var(--gray-500);font-size:0.9rem;line-height:1.6;font-weight:600;">
                            Empowering designers and building a community of style lovers who value authentic expression.
                        </p>
                    </div>
                </div>
            </div>
