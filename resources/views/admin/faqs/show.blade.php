...
@section('page_headers')
    <h3><i class="fa-duotone fa-users mr-2"></i>Faqs</h3>
@endsection
...
@section('page_buttons')
    <a class="btn btn-primary" href="{{ route('admin.faqs.create') }}"><i class="fa-solid fa-plus"></i> Add Faqs</a>
@endsection
                        ...
                        <div class="card-header">
                            <div class="w-100 d-flex justify-content-between ">
                                ...
                                <div class="d-flex align-items-center action_button">
                                    @include('admin.faqs.datatables_actions', ['uuid' => $faq->uuid])
                                </div>
                            </div>
                        </div>
